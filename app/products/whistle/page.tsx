...
export default function ProductDetailPage() {
  ...
  const product = {
    ...
    specs: [
      ...
      { label: "Power Source", value: "100% Battery-Free / Breath Powered" },
      { label: "Format", value: "Keychain & Zipper-Attachable" },
      { label: "Weight", value: "12 grams" },
    ],
    features: [
      "Zero setup required with immediate breath activation",
      "Dual-tube architecture for maximum sound projection",
      "Weather-resistant and unbreakable metal build",
      "Ultra-lightweight design for effortless everyday carry",
    ],
  };
             ...
             <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <ConfettiButton 
                  ...
                  onClick={() => {
                    ...
                    addToCart({
                      id: "whistle", // Fixed ID to match the product
                      name: product.name,
                      price: product.price,
                      quantity: quantity,
