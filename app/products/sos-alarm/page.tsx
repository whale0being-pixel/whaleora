...
export default function ProductDetailPage() {
  ...
  const product = {
    name: "SOS Personal Alarm",
    subtitle: "Acoustic Defense",
    price: 1799,
    rating: 4.9,
    reviewsCount: 128,
    description:
    ...
    specs: [
      { label: "Siren Output", value: "130dB High-Decibel Dual-Siren" },
    ...
    features: [
      "Instant activation via pull-pin mechanism",
      "Compact keychain format for effortless daily carry",
      "Discreet design that prioritizes preparedness over fear",
      "Weather-resistant casing for reliable outdoor performance",
    ],
  };
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <ConfettiButton 
                  ...
                  onClick={() => {
                    ...
                    addToCart({
                      id: "sos-alarm", // Fixed ID to match the product
                      name: product.name,
                      price: product.price,
                      quantity: quantity,
